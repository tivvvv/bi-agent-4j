    ...
    public Map<String, Object> apply(OverAllState state) throws Exception {
        ...
        Flux<String> content = chatClientBuilder
                ...
                .system("""
                        ...
                        6. 每个查询字段必须使用AS指定中文别名,别名要清晰简洁的描述字段含义,例如: user_name AS '用户名'.
                        7. 如果有多种SQL查询方案,优先选择最简洁,易理解,性能较好的方案.
                        8. 仅生成可执行的SQL语句,不输出其他任何与SQL无关的文字和解释.
                        9. 禁止以Markdown格式输出,直接以纯文本格式输出.
                        10. 输出中严禁包含'```','SQL'等字符,这些字符不是SQL的一部分,会影响SQL的正常执行.
                        11. 输出中不要有换行符,回车符等特殊字符,这些字符会影响SQL的正常执行.
                        """)
                .user(userInput)
                .stream()
                .content();
